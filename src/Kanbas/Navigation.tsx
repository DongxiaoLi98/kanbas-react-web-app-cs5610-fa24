...
export default function KanbasNavigation() {
  ...
  return (
    <div id="wd-kanbas-navigation" style={{ width:"105px"}} 
        className="nav list-group rounded-0 position-fixed bottom-0 top-0 d-none d-md-block bg-black z-2">

      {/* Navigate to NEU's page, the page is a new one */}
      ...
      {/* Navigate to each link without refreshing pages */}
      ...
      {/* Map each link to the path, and use useLocation() to check current path, chaning corresponding icon/label colors */}
      {links.map((link) => (
        ...
        <Link key={link.path} to={link.path} 
          ...
          {/* The link includes icon and label in it */}
